    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 mb-8">
        <div className="flex items-center space-x-4">
          <button
            onClick={handleBack}
            className="bg-white hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-xl border border-gray-300 transition-all duration-200 hover:scale-105 flex items-center space-x-2"
          >
