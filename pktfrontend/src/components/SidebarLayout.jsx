  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-8 relative overflow-hidden">
      ...
      <div className="flex gap-6 relative z-10">
        <aside
          className={`bg-white rounded-3xl border border-gray-200 shadow-xl h-[calc(100vh-3rem)] sticky top-6 transition-all duration-300 flex flex-col justify-between ${
                ...
                <div className="flex flex-col items-center md:items-stretch space-y-2">
                  {menuItems.map((mi) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`h-11 w-11 flex items-center justify-center rounded-2xl shadow-md transition-transform duration-200 ${
                            active
                              ? "from-blue-100 to-blue-200"
                              : `${mi.gradientFrom} ${mi.gradientTo}`
                          }`}
                        >
                          <svg
                            className="w-5 h-5"
                            fill="none"
                            stroke={active ? "#2563eb" : mi.stroke}
                            viewBox="0 0 24 24"
                  ...
                  {user?.role === "admin" && (
                    <>
                      ...
                      >
                        <div
                          className={`h-11 w-11 flex items-center justify-center rounded-2xl shadow-md ${
                            activeKey === "data-ruangan"
                              ? "from-blue-100 to-blue-200"
                              : "bg-purple-50"
                          }`}
